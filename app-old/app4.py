...
def carregar_dados_estoque(folder_path):
    ...
    for filepath in filepaths:
        ...
        try:
            ...
            # Limpeza de strings (remove espaços em branco e substitui NaNs)
            ...
            # Filtro de Validação: descarta linhas de cabeçalhos repetidos e linhas totalmente em branco
            ...
            # Adiciona identificadores de origem
